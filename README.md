...
4. **Live audio pipeline**：`audio-pipeline-sidecar` 已完成 contract-only 的 PCM16 level/peak/RMS、sequence、ring buffer 和 backpressure 协议；尚未接入生产 live-call，VAD/重采样/ASR 仍由现有路径负责。
